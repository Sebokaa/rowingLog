  ...
  const handleLogin = async (e) => {
    try {
      ...
      document.querySelector(".title").innerHTML =
        "<h1 className='error'>Invalid Credentials</h1>";
      console.log(e);
    }
  };
  ...
  const handleSignUp = async (e) => {
    try {
      ...
      if (emailInput.value === "" || passInput.value === "") {
        ...
        document.querySelector(".title").innerHTML =
          "<h1>Include At Least 1 Capital</h1>";
      } else {
        document.querySelector(".title").innerHTML =
      ...
      if (
        ...
        emailInput.value.includes("@microsoft.com") ||
        emailInput.value.includes("@smcm.edu") ||
        emailInput.value.includes("@icloud.com")
      ) {
        ...
        <div className="content">
          ...
          <div className="modalContainer">
            <div className="right">
              ...
              />
              <input className="lastName" placeholder="Last Name" onChange={(e) => setLastName(e.target.value)}/>
